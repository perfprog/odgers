...
Partial Class Assignments
    ...
    Protected Sub tabDetail_DataBound(sender As Object, e As System.EventArgs) Handles tabDetail.DataBound
        

    End Sub

    Protected Sub tabDetail_ItemCreated(sender As Object, e As System.EventArgs) Handles tabDetail.ItemCreated
    ...
    Function fsDate(ByVal d1 As Date, ByVal sCultureInit As String) As String
        ' MG 13-11-03 Changed 'M' specifier to 'MMMM dd, yyyy'
        fsDate = d1.ToString("MMMM dd, yyyy", New System.Globalization.CultureInfo(sCultureInit))
...
Folders_Done:
    ...
    Protected Sub tabDetail_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles tabDetail.PreRender
        ...
        Else
            ...
            hl1 = Me.tabDetail.FindControl("hlEmailRpt")
            'Trace.Warn("E" & Me.OfficeID.SelectedValue)
            hl1.Visible = UCase(Me.OfficeID.SelectedItem.Text) = "CEOX1DAY"
        End If
        ...
        'Email Reports
        'If OfficeId is DEOx1day, show Email Reportd link otherwise hide it
        'Dim hl1 As HyperLink
        'hl1 = Me.tabDetail.FindControl("hlEmailRpt")
        'Trace.Warn("XXX" & Me.OfficeID.SelectedValue)
        'hl1.Visible = UCase(Me.OfficeID.SelectedItem.Text) = "CEOX1DAY"
