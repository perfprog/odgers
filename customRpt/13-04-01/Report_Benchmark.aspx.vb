...
Partial Class CustomRpt_Report_HPI
    ...
    Dim sLeaderfitAnalysis As String, sDemonstratedStrengths As String, sAreastoDevelop As String
        ...
        For i1 = 0 To Me.pMain.Controls.Count - 1
            If Me.pMain.Controls(i1).ID <> "" Then
                ...
                For j1 = 0 To dvText.Table.Rows.Count - 1
                    ...
                    'Leaderfit
                    If dvText.Table.Rows(j1)("KeyName") = "hpi_demonstratedstrengths" Then
                        sDemonstratedStrengths = dvText.Table.Rows(j1)("KeyValue")
                    End If

                    If dvText.Table.Rows(j1)("KeyName") = "hpi_areastodevelop" Then
                        sAreastoDevelop = dvText.Table.Rows(j1)("KeyValue")
                    End If
                    ...
                    If dvText.Table.Rows(j1)("KeyName") = "rptname_benchmark" Then
                        If dvCan.Table.Rows(0)("AssgnTypeID") = 21 Or dvCan.Table.Rows(0)("AssgnTypeID") = 23 Or dvCan.Table.Rows(0)("AssgnTypeID") = 19 Then
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        If dvCan.Table.Rows(0)("LanguageID") = 8 Then
        ...
        If dvCan.Table.Rows(0)("AssgnTypeID") >= 20 And dvCan.Table.Rows(0)("AssgnTypeID") <= 23 Then
            Me.AssgnName.Text = ""
        Else
            Me.AssgnName.Text = dvCan.Table.Rows(0)("AssgnDesc")
        End If
    ...
    Protected Sub tabLF_ItemDataBound(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles tabLF.ItemDataBound
        ...
        'L1.Text = e.Item.DataItem("ScaleID") + 2
    End Sub
