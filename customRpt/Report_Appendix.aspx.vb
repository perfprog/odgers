...
Partial Class CustomRpt_Report_HPI
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Show/Hide HDS and MVPI
        Dim dv1 As System.Data.DataView
        dv1 = Me.rsHDS.Select(DataSourceSelectArguments.Empty)
        Me.pHDS.Visible = dv1.Table.Rows.Count > 0

        dv1 = Me.rsMVPI.Select(DataSourceSelectArguments.Empty)
        Me.pMVPI.Visible = dv1.Table.Rows.Count > 0
    End Sub
