<%@ Page Language="VB" Trace="false" Debug="false" EnableViewState="False" MasterPageFile="Leaderfit.master"
    AutoEventWireup="false" StylesheetTheme="creative" CodeFile="Report_HBC - Copy.aspx.vb"
    ...
    <asp:Panel runat="server" ID="pMain" Width="800">
        ...
        <table width="800" border="0">
            ...
            <tr>
                ...
                <td valign="top" align="right" style="padding-top: 90px; padding-right:20px;">
        ...
        <asp:SqlDataSource runat="server" ID="rsLF" ConnectionString="<%$ ConnectionStrings:cMain %>"
            SelectCommand="SELECT [ScaleID], [ScaleName], [ScaleDesc], ScaleType, IsHogan FROM [qryCan_Scales] WHERE ([CandidateID] = @CandidateID) ORDER BY [ScaleID]">
            <SelectParameters>
                ...
                <tr>
                    ...
                    <td valign="top" width="300">
                        ...
                        <table cellpadding="2" cellspacing="0" width="100%" border="0">
                            ...
                            <tr>
                                <td valign="top">
                                    <asp:Label runat="server" ID="benchmark_leaderfitanalysis2"></asp:Label>
                                </td>
                                <td width="10">
                                </td>
                                <td align="right" valign="top">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td valign="top" align="right">
                                            <asp:Label runat="server" ID="Pageno" Text='<%# Eval("ScaleID")+4 %>'></asp:Label>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                            ...
                            <asp:Repeater runat="server" ID="tabStrengths" DataSourceID="rsCanText">
                                <ItemTemplate>
                                    <tr runat="server" id="tr1">
                                        <td colspan="2">
                                            <asp:Label runat="server" ID="hpi_strengths" CssClass="h3" Text="Strengths"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <asp:Repeater runat="server" ID="tabLFDetail" DataSourceID="rsLF">
            <ItemTemplate>
                ...
                <div style="padding-left: 90px; padding-right: 50px;">
                    ...
                    <br />
                    <br />
                    <asp:Label runat="server" ID="hpi_demonstratedstrengths" CssClass="h3"></asp:Label>
                    <br />
                    <table width="100%" runat="server" id="list1" border="0">
                    </table>
                    <br />
                    <br />
                    <asp:Label runat="server" ID="hpi_areastodevelop" CssClass="h3"></asp:Label>
                    <br />
