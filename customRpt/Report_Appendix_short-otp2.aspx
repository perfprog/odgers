<%@ Page Language="VB" Trace="true" Debug="true" EnableViewState="False" MasterPageFile="Leaderfit.master"
    AutoEventWireup="false" StylesheetTheme="creative" CodeFile="Report_Appendix_short-otp2.aspx.vb"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel runat="server" ID="pMain" Width="800">
        <asp:SqlDataSource runat="server" ID="rsCanText" ConnectionString="<%$ ConnectionStrings:cMain %>"
            SelectCommand="SELECT [CandidateID], [ScaleID], [Score], GapScore, [LevelName], [Overview1], [Overview2], Strengths, Gaps, ScaleName, ScaleDesc, LF1, LF2, LF3, LF4, LF5, IsStrength1, IsStrength2, IsStrength3, IsStrength4, IsStrength5, isLF, GreyMin, GreyMax,valid FROM [qryCandidateText] WHERE ([CandidateID] = @CandidateID) ORDER BY [ScaleID]">
            <SelectParameters>
        ...
        <asp:SqlDataSource runat="server" ID="rsCanText1" ConnectionString="<%$ ConnectionStrings:cMain %>"
            SelectCommand="SELECT * FROM qryCandidateText_1 WHERE ([CandidateID] = @CandidateID)">
            <SelectParameters>
                <asp:QueryStringParameter Name="CandidateID" DefaultValue="1" QueryStringField="CandidateID"
                    Type="Int32" />
            </SelectParameters>
        ...
        <div style="padding-left: 90px; padding-right: 50px;">
            ...
            <asp:DataList runat="server" ID="tab2" DataSourceID="rsCanText1" ItemStyle-Width="200"
