<%@ Page Language="VB" Trace="true" Debug="false" EnableViewState="False" MasterPageFile="Leaderfit.master"
    AutoEventWireup="false" StylesheetTheme="creative" CodeFile="Report_Appendix_short.aspx.vb"
                                                ...
                                                <table visible="true" border="0" style="table-layout:fixed; width: 80px;" cellspacing="0" cellpadding="0" runat="server"
                                                    ...
                                                    <tr style="height:20px;">
                                                       <td width="20" valign="middle" >
                                                        <img src="../images/hds_bar.JPG" height=12 />
                                                    </td>
