<%@ Page Language="VB" Trace="true" Debug="true" EnableViewState="False" MasterPageFile="Leaderfit.master"
    AutoEventWireup="false" StylesheetTheme="creative" CodeFile="Report_Appendix_short-otp5.aspx.vb"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel runat="server" ID="pMain" Width="800">
        ...
        <!-- Appendix page 5 new HDS page 2016-08-26-->
        <p class="newpage">
            &nbsp;
        </p>
        ...
        <div style="padding-left: 90px; padding-right: 50px;">
            <asp:Label runat="server" ID="mvpi_subscalescores" Font-Bold="true" Text="Subscale Scores"></asp:Label><br />
            <hr />
            <asp:DataList CellSpacing="5" RepeatColumns="3" RepeatDirection="Horizontal" runat="server"
                BorderColor="White" BorderWidth="0" ID="tabMVPIOuter" Width=680>
                <ItemTemplate>
                    <table border="0" width="100%">
                        <tr>
                            <td style="border-right: 1px dashed #CCCCCC; padding-right: 2px;">
                                ...
                                <asp:SqlDataSource runat="server" ID="rsMVPI" ConnectionString="<%$ ConnectionStrings:cMain %>"
                                    SelectCommand="SELECT CandidateID, ScaleName, subScaleName, count1,itemcount FROM qryCan_MVPISubscales WHERE (CandidateID = @CandidateID) ORDER BY subScaleID">
                                    <SelectParameters>
                                        <asp:QueryStringParameter Name="CandidateID" QueryStringField="CandidateID" Type="Int32" />
                                        
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                <asp:GridView runat="server" ID="tabMVPI" CellPadding="0" CellSpacing="0" DataSourceID="rsMVPI"
                                    ShowHeader="true" AutoGenerateColumns="false" OnRowDataBound="populate_mvpi" BorderWidth="0"
                                    BorderStyle="None" GridLines="None">
                                    <Columns>
                                        <asp:BoundField DataField="SubScaleName" ItemStyle-Width="180" ItemStyle-HorizontalAlign="Right" />
                                        <asp:TemplateField>
