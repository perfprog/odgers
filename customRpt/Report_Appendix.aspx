...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel runat="server" ID="pMain" Width="800">
        ...
        <div style="padding-left: 50px; padding-right: 20px;">
            <asp:SqlDataSource runat="server" ID="rsHPI" ConnectionString="<%$ ConnectionStrings:cMain %>"
                SelectCommand="SELECT [CandidateID], [ScaleType], [ScaleID], [ScaleName], [ScaleDesc], [Score], ScaleName2 FROM [qryCandidateData_Hogan] WHERE Score>0 and ScaleType='HPI' and ([CandidateID] = @CandidateID) ORDER BY [ScaleOrder], [ScaleID]">
                <SelectParameters>
                    <asp:QueryStringParameter Name="CandidateID" QueryStringField="CandidateID" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:GridView runat="server" ID="tabHPI" AutoGenerateColumns="false" DataSourceID="rsHPI"
                ...
                <Columns>
                    <asp:BoundField DataField="ScaleName" HeaderText="Scale" ItemStyle-VerticalAlign="Top"
                        ItemStyle-Width="120" ItemStyle-CssClass="app_small" HeaderStyle-CssClass="app_small" />
        ...
        <!-- HDS -->
        <asp:Panel runat="server" ID="pHDS">
            <p class="newpage">&nbsp;
                &nbsp;</p>
            <uc:ph runat="server" ID="ph10b" />
            <uc:phtitle runat="server" ID="phtitle10b" pColorName="Cyan" />
            <asp:Label runat="server" ID="appendix_scoresb" Visible="false"></asp:Label>
            <div style="padding-left: 50px; padding-right: 20px;">
                <asp:SqlDataSource runat="server" ID="rsHDS" ConnectionString="<%$ ConnectionStrings:cMain %>"
                    SelectCommand="SELECT [CandidateID], [ScaleType], [ScaleID], [ScaleName], [ScaleDesc], [Score], ScaleName2 FROM [qryCandidateData_Hogan] WHERE Score>0 and ScaleType='HDS' and ([CandidateID] = @CandidateID) ORDER BY [ScaleOrder], [ScaleID]">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="CandidateID" QueryStringField="CandidateID" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <asp:GridView runat="server" ID="tabHDS" AutoGenerateColumns="false" DataSourceID="rsHDS"
                    GridLines="Both" BorderColor="Black" BorderStyle="Solid" BorderWidth="1" CellPadding="2"
                    CellSpacing="0">
                    <Columns>
                        <asp:BoundField DataField="ScaleName" HeaderText="Scale" ItemStyle-VerticalAlign="Top"
        ...
        <!-- MVPI -->
        <asp:Panel runat="server" ID="pMVPI">
            <p class="newpage">&nbsp;
                &nbsp;</p>
            <uc:ph runat="server" ID="ph10c" />
            <uc:phtitle runat="server" ID="phtitle10c" pColorName="Cyan" />
            <asp:Label runat="server" ID="appendix_scoresc" Visible="false"></asp:Label>
            <div style="padding-left: 50px; padding-right: 20px;">
                <asp:SqlDataSource runat="server" ID="rsMVPI" ConnectionString="<%$ ConnectionStrings:cMain %>"
                    SelectCommand="SELECT [CandidateID], [ScaleType], [ScaleID], [ScaleName], [ScaleDesc], [Score], ScaleName2 FROM [qryCandidateData_Hogan] WHERE Score>0 and ScaleType='MVPI' and ([CandidateID] = @CandidateID) ORDER BY [ScaleOrder], [ScaleID]">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="CandidateID" QueryStringField="CandidateID" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <asp:GridView runat="server" ID="tabMVPI" AutoGenerateColumns="false" DataSourceID="rsMVPI"
                    GridLines="Both" BorderColor="Black" BorderStyle="Solid" BorderWidth="1" CellPadding="2"
                    CellSpacing="0">
                    <Columns>
                        <asp:BoundField DataField="ScaleName" HeaderText="Scale" ItemStyle-VerticalAlign="Top"
                            ...
                            <table width="372" border="0" bordercolor="red" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" width="134">
                                        <asp:Label runat="server" ID="txtLow"></asp:Label>
                                    </td>
                                    <td align="center" width="104">
                                        <asp:Label runat="server" ID="txtAvg"></asp:Label>
                                    </td>
                                    <td align="center" width="133">
                                        <asp:Label runat="server" ID="txtHigh"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </FooterTemplate>
        ...
        <p class="newpage">&nbsp;
            &nbsp;</p>
        <uc:ph runat="server" ID="ph8b" />
        <uc:phtitle runat="server" ID="phtitle8b" pColorName="Cyan" />
        <asp:Label runat="server" ID="hpi_appendixb" Visible="false"></asp:Label>
        <div style="padding-left: 90px; padding-right: 50px;">
        ...
        <div style="padding-left: 90px; padding-right: 50px;">
            ...
            <asp:DataList runat="server" ID="tab2" DataSourceID="rsCanText" ItemStyle-Width="200"
                BorderStyle="Solid" BorderColor="Silver" GridLines="Both" RepeatColumns="3" RepeatDirection="Horizontal"
