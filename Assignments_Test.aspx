<%@ Page Language="VB" Trace="false" Debug="false" MasterPageFile="~/Admin.master"
    AutoEventWireup="false" CodeFile="Assignments_Test.aspx.vb" Inherits="Assignments"
                ...
                <asp:DetailsView ID="tabDetail" runat="server" DataSourceID="rsDetail" Visible="True"
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText="Email Text">
                            <EditItemTemplate>
                                <asp:HyperLink runat="server" ID="hlEmail" Text="Email Message" NavigateUrl='<%# "Assgn_Email.aspx?AssgnID=" & Eval("AssgnID") %>'
                                    Target="basecamp"></asp:HyperLink>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                            </InsertItemTemplate>
    ...
    <asp:Panel runat="server" ID="pCandidates">
        ...
        <div class="note" style="width: 600px;">
            <ol>
                ...
                <li style="padding-bottom: 10px;"><b>To select finalist report (LFP): To be used with Odgers LeaderFit Potential or Benchmark Report for candidate debriefs. (Additional $150): </b>Please place a checkmark in the green box, and use the calendar icon (below) to select the completion date, then click the SEND button. To confirm it was sent hit the “refresh button” and the date should appear below.</li>
            </ol>
        </div>
        <br />
        ...
        <asp:GridView ID="tabCandidates" runat="server" AutoGenerateColumns="False" DataKeyNames="AssgnID,CandidateID"
            ...
            <Columns>
                ...
                <asp:TemplateField SortExpression="LanguageID" HeaderText="Lang. for Odgers Custom Reports">
                    <ItemTemplate>
