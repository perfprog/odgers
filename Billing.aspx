<%@ Page Language="VB" Trace="false" Debug="false" MasterPageFile="admin.master" StylesheetTheme="Admin"
    AutoEventWireup="false" CodeFile="Billing.aspx.vb" Inherits="PPI_Billing" Title="Billing" %>

<%--Copy of pPI/Billing_Smarter.aspx--%>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="Section">
        View Billing Data</div>
    <table>
        <tr>
            <td>
                <b>Month</b>
        ...
        <tr>
            ...
            <td>
                <asp:Button runat="server" ID="btnSubmit" Visible="false" Text="Scan Folder" ToolTip="use just once" />
            </td>
        </tr>
        <tr runat="server" id="totalrow">
            <td>
                <b>Total Report Count: </b>
            </td>
            <td>
                <asp:Label runat="server" ID="TotalCount" Text="0"></asp:Label>
            </td>
        </tr>
    </table>
    <asp:SqlDataSource runat="server" ID="rsOffice" ConnectionString="<%$ ConnectionStrings:cMain %>"
        ...
        <SelectParameters>
            <asp:CookieParameter CookieName="OfficeID" Name="officeID" />
