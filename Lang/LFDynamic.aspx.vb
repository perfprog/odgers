    ...
    Sub Data_Save()
        ...
        For Each gr In Me.tabA.Rows
            If gr.RowType = DataControlRowType.DataRow Then
                ...
                sSql = "Update LFText Set "
                T1 = gr.FindControl("HighText")
                sSql = sSql & " HighText=N'" & Replace(T1.Text, "'", "''") & "'"
               
                T1 = gr.FindControl("MedText")
                sSql = sSql & ", MedText=N'" & Replace(T1.Text, "'", "''") & "'"

                T1 = gr.FindControl("LowText")
                sSql = sSql & ", LowText=N'" & Replace(T1.Text, "'", "''") & "'"
