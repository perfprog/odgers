...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:SqlDataSource ID="rsA" runat="server" ConnectionString="<%$ ConnectionStrings:cMain %>"
        SelectCommand="SELECT [LanguageID], [EngScaleName], [EngScaleDesc], [ScaleName], [ScaleDesc], AutoID FROM [Lang_Scales] WHERE ([LanguageID] = @LanguageID) ORDER BY IsHogan, [EngScaleName]">
        <SelectParameters>
