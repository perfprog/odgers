...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:SqlDataSource ID="rsA" runat="server" ConnectionString="<%$ ConnectionStrings:cMain %>"
        SelectCommand="SELECT [LanguageID], [EngScaleName], [EngScaleDesc], [ScaleName], [ScaleDesc], HoganComps, HPIScales, IsNull(EngHoganComps, '') as EngHoganComps, IsNull(EngHPIScales, '') as EngHPIScales, AutoID FROM [Lang_Scales] WHERE ([LanguageID] = @LanguageID) ORDER BY IsHogan Desc, [ScaleID]">
        <SelectParameters>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="ScaleDesc" SortExpression="EngScaleDesc" ItemStyle-VerticalAlign="Bottom">
             ...
             <asp:TemplateField HeaderText="HPI Scales" SortExpression="EngHPIScales" ItemStyle-VerticalAlign="Bottom">
               ...
               <HeaderTemplate>
               <b>HPI Scales</b><br />
               <small>Please enter Hogan HPI scale names exactly as defined on the "Hogan Scales" page </small>
               </HeaderTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
