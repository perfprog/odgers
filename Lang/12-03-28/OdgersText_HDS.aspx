...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="rsA" runat="server" ConnectionString="<%$ ConnectionStrings:cMain %>"
        SelectCommand="SELECT JobRiskDesc, EnglishJobRiskDesc,[LanguageID], [ScaleID], [LevelName], AutoID FROM [Lang_OdgersText_HDs] WHERE (([LanguageID] = @LanguageID) AND ([ScaleID] = @ScaleID) AND ([LevelName] = @LevelName))">
        <SelectParameters>
            ...
            <ItemTemplate>
                <tr>
                    <td valign="top">
                        ...
                        <b>Job Risk Desc: </b>
                        <asp:Label runat="server" ID="EnglishJobRiskDesc" Text='<%# Eval("EnglishJobRiskDesc") %>'></asp:Label>
                        <br /><br /><asp:TextBox TextMode="Multiline" Rows="10" Columns="50" runat="server" ID="JobRiskDesc"
                            ...
                            <br />
                        Max. Allowed:
                        <asp:Label runat="server" ID="maxlength1" ForeColor="Green" Text='<%# Len(Eval("EnglishJobRiskDesc")) %>'></asp:Label>&nbsp
                        &nbsp; Chars Left:
