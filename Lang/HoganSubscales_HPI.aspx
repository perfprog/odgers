<%@ Page Language="VB" Trace="False" MasterPageFile="~/Lang/Lang.master" ValidateRequest="False"
    AutoEventWireup="false" CodeFile="HoganSubscales_HPI.aspx.vb" Inherits="Lang_HoganScales"
    Title="Hogan *HPI* Subscales" StylesheetTheme="admin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:SqlDataSource ID="rsA" runat="server" ConnectionString="<%$ ConnectionStrings:cMain %>"
        SelectCommand="SELECT [LanguageID], [EngsubScaleName], [SubscaleName], AutoID FROM [Lang_HoganSubscales_HPI] WHERE ([LanguageID] = @LanguageID) ORDER BY subscalename">
        <SelectParameters>
            <asp:CookieParameter CookieName="LanguageID" Name="LanguageID" Type="Byte" />
        </SelectParameters>
    </asp:SqlDataSource>
    <div class="Section">
        Hogan Subscales (HPI)</div>
    <br />
