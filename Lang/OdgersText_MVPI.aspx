...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="rsA" runat="server" ConnectionString="<%$ ConnectionStrings:cMain %>"
        SelectCommand="SELECT Overview1, Overview2, EngOverview1, EngOverview2, [LanguageID], [ScaleID], [LevelName], AutoID FROM [Lang_OdgersText_MVPI] WHERE (([LanguageID] = @LanguageID) AND ([ScaleID] = @ScaleID) AND ([LevelName] = @LevelName))">
        <SelectParameters>
            ...
            <ItemTemplate>
                <tr>
                    <td valign="top">
                        ...
                        &nbsp; Chars Left: <span id="charsleft1"></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
