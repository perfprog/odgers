...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table >
        <tr>
            ...
            <td valign="top">
                <asp:RadioButtonList runat="server" ID="ScaleID" DataSourceID="rsScale" DataTextField="ScaleName"
                    DataValueField="ScaleID" RepeatColumns="3" RepeatDirection="Horizontal">
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
            ...
            <td valign="top">
                <asp:RadioButtonList runat="server" ID="Levelname" RepeatDirection="Horizontal">
            ...
            <ItemTemplate>
                ...
                <tr>
                    <td valign="top">
                        ...
                        &nbsp; Chars Left: <span id="charsleft2"></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        ...
                        &nbsp; Chars Left: <span id="charsleft3"></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        ...
                        &nbsp; Chars Left: <span id="charsleft4"></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        <b>Strategic Clarity: </b>
                        ...
                        &nbsp; Chars Left: <span id="charsleft5"></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        ...
                        &nbsp; Chars Left: <span id="charsleft6"></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        <b>Resilience and Adaptability: </b>
                        ...
                        &nbsp; Chars Left: <span id="charsleft7"></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        ...
                        &nbsp; Chars Left: <span id="charsleft8"></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        <b>People and Team Dev.: </b>
                        ...
                        &nbsp; Chars Left: <span id="charsleft9"></span>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        ...
                        &nbsp; Chars Left: <span id="charsleft10"></span>
                    </td>
                </tr>
                <tr>
                    <td align="right">
