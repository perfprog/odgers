...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="rsA" runat="server" ConnectionString="<%$ ConnectionStrings:cMain %>"
        SelectCommand="SELECT [Overview1], [Strengths], [Overview2],  [Gaps], [LF1], [LF2], [LF3], [LF4], [LF5], [AutoID], [EngOverview1], [EngStrengths], [EngOverview2], [EngGaps], [EngLF1], [EngLF2], [EngLF3], [EngLF4], [EngLF5], [LanguageID], [ScaleID], [LevelName] FROM [Lang_OdgersText_HPI] WHERE (([LanguageID] = @LanguageID) AND ([ScaleID] = @ScaleID) AND ([LevelName] = @LevelName))">
        <SelectParameters>
