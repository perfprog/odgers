<%@ Page Language="VB" Trace="False" MasterPageFile="~/Lang/Lang.master" ValidateRequest="False"
    AutoEventWireup="false" CodeFile="HoganScales.aspx.vb" Inherits="Lang_HoganScales"
    Title="Hogan Scales" StylesheetTheme="admin" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="ScaleName" SortExpression="EngScaleName" ItemStyle-VerticalAlign="Bottom">
                <ItemTemplate>
                    ...
                    <asp:TextBox ID="ScaleName" runat="server" Text='<%# Bind("ScaleName") %>' Columns="20"
