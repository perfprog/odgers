<%@ Page Language="VB" Trace="false" Debug="false" MasterPageFile="~/PPI/PPI.master" StylesheetTheme="Admin" AutoEventWireup="false" CodeFile="Billing.aspx.vb" Inherits="PPI_Billing" title="Untitled Page" %>
...
<asp:SqlDataSource runat=server ID=rsOffice ConnectionString="<%$ ConnectionStrings:cMain %>" SelectCommand="SELECT [OfficeID], [OfficeName] FROM [Offices] ORDER BY [OfficeName]"></asp:SqlDataSource>
...
&nbsp; (Count: <asp:Label runat=server ID=ReportCount Text=0></asp:Label>)
</div>
<br />
<asp:GridView runat=server ID=tabData ShowFooter=False CellPadding=5 CellSpacing=0 FooterStyle-CssClass="footrow" 
